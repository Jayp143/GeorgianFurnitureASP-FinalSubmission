...
namespace GeorgianFurniture.Controllers
{
    ...
    public class FurnituresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("furnitureID,furnitureType,color,categoryID")] Furniture furniture)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("furnitureID,furnitureType,color,categoryID")] Furniture furniture)
        {
